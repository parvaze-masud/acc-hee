                ...
                <div class="navbar-wrapper">
                    ...
                    <div class="navbar-container container-fluid">
                        <ul class="nav-left">
                            ...
                            <li>
                                <h6 class="full-screen p-1" style="text-align: center">Welcome to {{ company()->company_name }}</h6>
                                <h6 class="full-screen" style="text-align: center"> Financial Year: {{ company()->financial_year_start }} to {{ company()->financial_year_end }}</h6>
                            </li>
                        </ul>
                        <ul class="nav-right">
