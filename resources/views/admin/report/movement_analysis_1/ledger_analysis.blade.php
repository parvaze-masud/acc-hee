...
@component('components.report', [
    ...
    'print_header'=>'Ledger Analysis',
]);

<!-- Page-header component -->
@slot('header_body')
    <form id="ledger_analysis"  method="POST">
        @csrf
        {{ method_field('POST') }}
        <div class="row ">
            <div class="col-md-3">
    ...
    <table id="tableId" style=" border-collapse: collapse; " class="table table-striped customers table-scroll">
        ...
        <tfoot>
            <tr>
                ...
                <th style="width: 2%; font-size: 18px;"  class="th total_inwards_value"></th>
...
// ledger analysis function
function get_ledger_analysis(response){
    ...
    var tree=getTreeView(response.data,children_sum);
       $('.item_body').html(tree);
        ...
        $('.total_inwards_value').text((total_inwards_value||0).toFixed(amount_decimals).replace(/\d(?=(\d{3})+\.)/g, '$&,'));
