                                        ...
                                        <div class="card-block">
                                            <div class="row m-b-25">
                                                <div class="col-auto p-r-0">
                                                    <div class="u-img">
                                                        <img src="{{asset('libraries\assets\images\breadcrumb-bg.jpg')}}" alt="user image" class="img-radius cover-img">
                                ...
                                <div class="col-xl-3 col-md-6">
                                    <div class="card wather-card">
                                        <div class="nature-card">
                                            <img src="{{asset('libraries\assets\images\widget\wathernature.png')}}" alt="whether image" class="img-fluid main-img">
                                            <img src="{{asset('libraries\assets\images\widget\watherstar1.png')}}" alt="whether image" class="snow1">
                                            <img src="{{asset('libraries\assets\images\widget\watherstar2.png')}}" alt="whether image" class="snow2">
                                            <img src="{{asset('libraries\assets\images\widget\watherbottom.png')}}" alt="whether image" class="bottom-img">
