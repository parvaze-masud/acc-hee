...
@section('title','Voucher Purchase')
@push('css')
      ...
      <br>
        ...
        <div class="main-body ">
          <div class="page-wrapper m-t-0 m-l-1  p-10">
            ...
            <form id="edit_purchase_id"  method="POST">
                @csrf
                {{ method_field("PUT") }}
            <div class="page-body">
                  <div class="row">
                  ...
                  <tfoot>
                      <tr>
                         ...
                         @endif
                          ...
                          <td></td>
                          <td></td>
                          <td><input type="text" name="total_amount" style="border-radius: 15px;font-weight: bold;" class="total_amount form-control text-right" readonly></td>
                          <td class="col-1 {{$voucher->remark_is==0?'d-none':'' }}"></td>
                      </tr>
                  </tfoot>
            ...
            <div align="center">
              <button  type="submit" class="btn btn-info edit_purchase_btn cansale_btn" style="width:120px;border-radius: 15px;"><span class="m-1 m-t-1" style="color:#404040"><i class="fa fa-save" style="font-size:18px;" ></i></span><span >Update</span></button>
...
// edit purchase
$(document).ready(function(){
$("#edit_purchase_id").submit(function(e) {
  e.preventDefault();
  const fd = new FormData(this);
  var id="{{$data->tran_id}}";
  $(".edit_purchase_btn").text('Update');
  $.ajax({
