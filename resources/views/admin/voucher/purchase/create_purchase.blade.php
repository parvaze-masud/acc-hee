      ...
      <br>
        ...
        <div class="main-body ">
          <div class="page-wrapper m-t-0 m-l-1  p-10">
            ...
            <form id="add_purchase_id"  method="POST">
                @csrf
            <div class="page-body">
                  <div class="row">
                    <div class="col-sm-4" >
            ...
            <div align="center">
              <button  type="submit" class="btn btn-info add_purchase cansale_btn" style="width:116px;border-radius: 15px;"><span class="m-1 m-t-1" style="color:#404040"><i class="fa fa-save" style="font-size:18px;" ></i></span><span  >Save</span></button>
...
// insert purchase
$(document).ready(function(){
    $("#add_purchase_id").submit(function(e) {
    e.preventDefault();
    const fd = new FormData(this);
    $("#add_purchase").text('Add');
        $.ajax({
                url: '{{ route("voucher-purchase.store") }}',
                method: 'post',
                data: fd,
                cache: false,
                contentType: false,
