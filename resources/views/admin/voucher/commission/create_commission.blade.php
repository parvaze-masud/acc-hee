        ...
        <form id="add_commission" method="POST">
            ...
            <div class="row">
                <div class="col-sm-4" >
                    ...
                    <input type="text" name="invoice_no"   class="form-control m-1" value="{{$voucher_invoice}}"  {{$voucher_invoice?'readonly':''}}   style="color: green" required/>
                    ...
                    <div class="row">
                        <div class="col-sm-6" >
                            ...
                            <input type="text" name="ref_no" class="form-control m-1"  required />
                        </div>
                        <div class="col-sm-6" >
                    ...
                    <table  id="example"  style=" border-collapse: collapse; "   class="table table-striped customers " >
                      ...
                      <tfoot>
                        <tr>
                            ...
                            <th style="width: 3%;  border: 1px solid #ddd;" style="font-weight: bold;" class="sale_qty"></th>
                            <th style="width: 3%;  border: 1px solid #ddd;" style="font-weight: bold;" class="sale_rate"></th>
                            <th style="width: 3%;  border: 1px solid #ddd;" style="font-weight: bold;" class="sale_value"></th>
                            ...
                            <th style="width: 3%;  border: 1px solid #ddd;" ><input type="number" style="font-weight: bold;" name="total_commission_per" class="form-control total_commission_per" readonly/> </th>
                        </tr>
                    <tfoot>
                </table>
            </div>
            ...
            <div align="center">
              <button  type="submit" class="btn btn-info add_commission_btn" style="width:116px;border-radius: 15px;"><span class="m-1 m-t-1" style="color:#404040"><i class="fa fa-save" style="font-size:18px;" ></i></span><span  >Save</span></button>
