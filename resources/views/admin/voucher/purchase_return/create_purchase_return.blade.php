      ...
      <br>
        ...
        <div class="main-body ">
          <div class="page-wrapper m-t-0 m-l-1  p-10">
            ...
            <form id="add_purchase_return_id"  method="POST">
                @csrf
            <div class="page-body">
                  <div class="row">
                    <div class="col-sm-4" >
            ...
            <div align="center">
              <button  type="submit" class="btn btn-info add_purchase_return_btn" style="width:116px;border-radius: 15px;"><span class="m-1 m-t-1" style="color:#404040"><i class="fa fa-save" style="font-size:18px;" ></i></span><span  >Save</span></button>
      ...
      for(var row=1; row<6;row++) {
          rowCount++;
              $('#orders').append(`<tr  style="margin:0px;padding:0px;" class="p-0 m-0"  id="row${rowCount}">
                  ...
                  <td  class="m-0 p-0">
                      <input class="form-control rate text-right "  name="rate[]" step="any" data-field-name="rate" type="number" data-type="rate" id="rate_${rowCount}"  for="${rowCount}" ${stock_item_price_typeabe==0?'readonly':''} />
                  </td>
                  <td  class="m-0 p-0">
...
$(document).ready(function(){
    ...
    $('#add_commission').click(function() {
        ...
        $('#commission_append').append(`<tr id="${ComRowCount}">
                ...
                <td  colspan="3" class="m-0 p-0" > <select name="commission_ledger_id[]" class="form-control select2 commission_select2_${ComRowCount}" id="select_${ComRowCount}" >
                <option value="0">--Select--</option>
...
<script>
$(document).ready(function(){
        $("#add_purchase_return_id").submit(function(e) {
        e.preventDefault();
        const fd = new FormData(this);
        $(".add_purchase_return_btn").text('Add');
        $.ajax({
                url: '{{ route("voucher-purchase-return.store") }}',
                method: 'post',
                data: fd,
                cache: false,
                contentType: false,
