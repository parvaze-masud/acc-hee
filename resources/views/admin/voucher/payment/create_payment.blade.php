...
<div class="pcoded-content  " style="background-color:#ccffff!important">
            ...
            for(var row=1; row<6;row++) {
                ...
                if(ledger_debit.length){
                    ...
                    if(ledger_debit.length &&rowCount==3){
                        ...
                        <td  class="m-0 p-0">
                            <input class="form-control debit text-right " name="debit[]" data-field-name="debit" type="number" step="any" data-type="debit" id="debit_${rowCount}"  for="${rowCount}"/ readonly>
                        </td>
                        <td  class="m-0 p-0">
                            <input class="form-control credit  text-right" type="number" name="credit[]" step="any" type="text" id="credit_${rowCount}"   for="${rowCount}" />
                        </td>
                        <td  class="m-0 p-0 ${remark_is==0?'d-none':''}">
                    ...
                    if(rowCount>3){
                        ...
                        <td  class="m-0 p-0">
                            <input class="form-control credit  text-right"   name="credit[]" type="number" step="any" id="credit_${rowCount}"   for="${rowCount}" readonly/>
                        </td>
                        <td  class="m-0 p-0 ${remark_is==0?'d-none':''}">
                            <input class="form-control remark"  name="remark[]" type="text" data-type=" id="remark_${rowCount}"  autocomplete="off" for="${rowCount}"/>
                        </td>
