      ...
      <br>
        ...
        <div class="main-body ">
          <div class="page-wrapper m-t-0 m-l-1  p-10">
            ...
            <form id="add_grn_id"  method="POST">
                @csrf
            <div class="page-body">
                  <div class="row">
                    <div class="col-sm-4" >
                        ...
                        <div class="row " style="margin-top: 5px;">
                            ...
                            <div class="col-sm-8 m-0 p-0"  style="margin-left: 5px;!important;" >
                               <select  style="border-radius: 15px;" name="debit_ledger_id"  class="form-control m-1 js-example-basic-single  js-example-basic debit_ledger_id" required>
                                ...
                                <input type="text" name="credit_ledger_name"  id="credit_ledger_name" class="form-control credit_ledger_name" value="{{$ledger_name_credit_wise->ledger_name??''}}" style="margin-bottom: 4px !important;margin-top: 2px;" required/>
            ...
            <div align="center">
              <button  type="submit" class="btn btn-info add_grn_btn cansale_btn" style="width:116px;border-radius: 15px;"><span class="m-1 m-t-1" style="color:#404040"><i class="fa fa-save" style="font-size:18px;" ></i></span><span  >Save</span></button>
...
$(document).ready(function(){
  ...
  $('#orders').on('keyup change select','.product_name,.qty,.rate',function(){
   ...
   $(document).ready(function(){
    ...
    $('#add_commission').click(function() {
      ...
      $('#commission_append').append(`<tr id="${ComRowCount}">
            ...
            <td  colspan="2" class="m-0 p-0" > <select name="commission_ledger_id[]" class="form-control select2 commission_select2_${ComRowCount}" id="select_${ComRowCount}" >
            <option value="0">--Select--</option>
...
<script>
$(document).ready(function(){
    $("#add_grn_id").submit(function(e) {
    e.preventDefault();
    const fd = new FormData(this);
    $("#add_grn_btn").text('Add');
        $.ajax({
                url: '{{ route("voucher-grn.store") }}',
                method: 'post',
                data: fd,
                cache: false,
                contentType: false,
