...
class VoucherReceivedRepository implements VoucherReceivedInterface
{
    ...
    public function storeVoucherReceived($request, $voucher_invoice)
    {
    ...
    public function editDebitCredit($id)
    {
        return DB::table('debit_credit')
            ->select('debit_credit.debit_credit_id', 'debit_credit.ledger_head_id', 'ledger_head.ledger_name', 'debit_credit.debit', 'debit_credit.credit', 'debit_credit.comm_level', 'debit_credit.dr_cr', 'debit_credit.remark', 'debit_credit.commission', 'debit_credit.commission_type')
