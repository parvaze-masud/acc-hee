...
class GtnController extends Controller
{
    ...
    public function store(Request $request)
    {
        if (count(array_filter($request->product_id)) != 0) {
            ...
            return RespondWithError('Voucher Gtn Not successful !!', 'Product not Empty', 422);
        }
    }
